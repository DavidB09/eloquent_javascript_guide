...
(function () {
	...
	document.getElementById("exercise-problems").addEventListener('click', (e) => {
		...
		if (targetElement.classList.contains("clickable")) {
			let newLineNum = targetElement.getAttribute('data-line-number'); 
			let answerTitle = targetElement.closest(".body").id.split('explanation-'); 
			let answerElement = document.getElementById(answerTitle.join('')).querySelector('#linkable'); 
			
			var mutateDom2  = highlightLines(answerElement, newLineNum, 'temporary'); 
			mutateDom2(); 
		};
	})
